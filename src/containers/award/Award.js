              ...
              <div key={index} className="awardCertificate-card">
                <div className="card-row row-1">
                  <div className="card-image">
                    <img
                      src={award.certificateImage || "path/to/default-image.jpg"} // Fallback to default image
                      alt={award.title}
                      onClick={() => openPopup(award.certificateImage || "path/to/default-image.jpg")} // Fallback to default image on click
